...
<body>
        ...
        PreparedStatement ps=(PreparedStatement)con.prepareStatement("select * from decoration");
    ...
    <div class="page-wrapper bg-gra-01 p-t-180 p-b-100 font-poppins">
        <div class="wrapper wrapper--w780">
            <div class="card card-3">
                ...
                <div class="card-body">
                    <h2 class="title">Decoration Info</h2>
                    <form action="plan1.jsp" method="POST">
                        ...
                        <div class="input-group">
                            ...
                            <input class="input--style-3" type="text" placeholder="Enter Rate for Balloon" name="ballon" required>
                        </div>
                        
                        <div class="input-group">
                            <input class="input--style-3" type="text" placeholder="Enter Rate for Flower" name="flower" required>
                        </div>
                        
                        <div class="input-group">
                            <input class="input--style-3" type="text" placeholder="Enter Rate for Wooden" name="wooden" required>
                        </div>
