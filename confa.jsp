                ...
                <div class="card-body">
                    ...
                    <form action="success.jsp" method="POST">
                          <div class="input-group">
                            <input class="input--style-3" type="text" placeholder="ID" name="id" value=<%=id%>>
                        </div>
                        
                          <div class="input-group">
                            <input class="input--style-3" type="text" placeholder="ID" name="id" value=<%=fbill%>>
                        </div>
                        
                        <div class="input-group">
                            <input class="input--style-3" type="text" minlength="15" maxlength="15" placeholder="Enter Account No" name="name" required>
