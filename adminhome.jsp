...
<div class="w3-top">
  <div class="w3-bar w3-white w3-padding w3-card" >
    ...
    <div class="w3-right w3-hide-small">
      ...
      <a href="viewall.jsp" class="w3-bar-item w3-button">CATERING</a>

        <a href="viewall1.jsp" class="w3-bar-item w3-button">DECORATION</a>               
        <a href="pending.jsp" class="w3-bar-item w3-button">PENDING REQUEST</a>
         <a href="complete.jsp" class="w3-bar-item w3-button">COMPLETE REQUEST</a>
